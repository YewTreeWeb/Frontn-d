...
function yewtree_settings(){
  ...
  add_settings_section( 'yewtree-theme-settings', 'Theme Settings', 'yewtree_theme_settings', 'yewtree_web_theme');

  add_settings_field( 'post-formats', 'Post Formats', 'yewtree_post_formats', 'yewtree_web_theme', 'yewtree-theme-settings' );

	add_settings_field( 'custom-header', 'Custom Header', 'yewtree_custom_header', 'yewtree_web_theme', 'yewtree-theme-settings' );

	add_settings_field( 'custom-background', 'Custom Background', 'yewtree_custom_background', 'yewtree_web_theme', 'yewtree-theme-settings' );
